...
exports.getUserDetails = (userID) =>
  new Promise(async (resolve, reject) => {
    ...
    try {
      let query =  `SELECT "UserID","PasswordHash", b."RoleName", "AccessFailedCount", "IsLoggedIn", a."Status",c."userName" as name from "UserLogin" a inner join "UserRole" b on a."RoleID" = b."RoleID"  left join "Registration" c on c."userId" = a."UserID" where "UserID"= $1 and a."Status"=true`;
      const values = [userID];
